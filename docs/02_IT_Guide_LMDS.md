...
| SCHEMA_VERSION    | 6.0.075             | เวอร์ชัน Schema ปัจจุบัน     |
...
>
> **เวอร์ชันเอกสาร:** 1.7 (ปรับปรุงตามโค้ดจริง V6.0.075 DOC-CODE SYNC) | **วันที่:** 25 กรกฎาคม 2569
>
> **✅ หมายเหตุ — เวอร์ชันซิงค์แล้ว:**
>
> 1. **APP_VERSION ในโค้ด = `6.0.075`** — ตรงกันกับ System Guide แล้ว (V5.5.017 SECURITY-POSTFIX เพิ่ม SEC-008→012, OAuth scopes 10→6, V6.0.072: `isAuthorizedOrFail_()` fail-closed 24 call sites, Sheet Protection 8/19 + Q_REVIEW range, Production Readiness 95%→97%)
...
>
> **สถิติระบบ:** ฟังก์ชัน 544 | บรรทัดโค้ด ~28,236 | IDX sets 16 | Compliance 16/16 COMPLIANT (Rule 16: Security-First Design, SEC-001→012, 19 audit cycles, 116+ issues fixed, 97% Production Readiness, OAuth scopes 10→6, V6.0.072: isAuthorizedOrFail_() fail-closed 24 sites, Sheet Protection 8/19 + Q_REVIEW range)
