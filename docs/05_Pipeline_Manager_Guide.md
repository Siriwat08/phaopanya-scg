...
triggers.forEach((t) => console.log(t.getHandlerFunction(), t.getTriggerSource(), t.getEventType(), t.getUniqueId()));
```
...
_เอกสารนี้เป็นส่วนหนึ่งของชุดเอกสาร LMDS V6.0.075 — Pipeline Manager Module_
