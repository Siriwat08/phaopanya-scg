...
**Version:** V6.0.075 (DOC-CODE SYNC) | **อัปเดตล่าสุด:** 2026-07-25
...
_(ใช้อ้างอิงมาตรฐานเทียบกับไฟล์: `/กฎการเขียนโค้ด LMDS.md` และ `/📋กฎการเขียนโค้ด.md` เสมอ)_
...
_User จะส่งคำสั่งในรูปแบบ `[CMD: <คำสั่ง>]` ด้านล่างนี้ ให้คุณรันผลลัพธ์ตาม Format ที่ระบุของคำสั่งนั้นๆ เท่านั้น_
...
_เอกสารนี้อัปเดตล่าสุดเมื่อ: 2026-07-25 | Version: V6.0.075 (DOC-CODE SYNC, 19 audit cycles, 116+ issues fixed)_
