...
# ⚠️ DEPRECATED — LMDS System Workflow (ฉบับเก่า V6.0.044)

> **🚨 เอกสารนี้เลิกใช้แล้ว** (V6.0.074 — 2026-07-24)
>
> **เหตุผลที่เลิกใช้:**
>
> - อ้างอิง V6.0.044 (ปัจจุบัน V6.0.073+)
> - บอกว่าระบบมี "2 กลุ่ม" แต่จริงมี 5 กลุ่ม (Group 0, 1, 2, 3, 4)
> - อ้าง path `src/0_core_system/` แต่จริงคือ `src/O_core_system/` (ตัว O ใหญ่)
> - จำนวนบรรทัดที่อ้างผิด 25-48 บรรทัด
> - ไม่กล่าวถึง 6 ฟีเจอร์ใหญ่ (RBAC, Audit Trail, WebApp, PipelineManager, SnapshotTest, Hardening)
> - ไม่กล่าวถึง 5 V6.0 sheets (SYS_NOTES, SYS_NEGATIVE_SAMPLES, SYS_AUDIT_TRAIL, PIPELINE_RUN_LOG, TEST_MATCH_RESULTS)
> - มี fabricated reference ("Single Writer comment ที่ 18:204-206" ไม่มีจริง)
>
> **แทนที่ด้วย:**
>
> - [`docs/LMDS_SYSTEM_WORKFLOW_TH.md`](LMDS_SYSTEM_WORKFLOW_TH.md) — ฉบับใหม่ (Actual Code Behavior V6.0.073)
> - [`docs/LMDS_SYSTEM_WORKFLOW_CODEBASE_TH.md`](LMDS_SYSTEM_WORKFLOW_CODEBASE_TH.md) — ฉบับอธิบาย codebase ลึก + bug 6 จุดที่พบ
>
> **เก็บไว้เพื่อ:** การอ้างอิงทางประวัติศาสตร์เท่านั้น — ห้ามใช้เป็น source of truth

---

# LMDS System Workflow อธิบายการทำงานระบบ (เดิม V6.0.044)

ไฟล์นี้อธิบายระบบ LMDS จากโค้ดจริงในโปรเจกต์ ณ วันที่ 2026-07-13 (V6.0.044 DOC-CODE SYNC, 18 audit cycles complete) โดยเน้นว่าแต่ละชีตทำงานร่วมกันอย่างไร คอลัมน์ใดเป็นจุดเชื่อม และกฎธุรกิจล่าสุดของ Group 2 ที่ต้องใช้ `ShipToName` เท่านั้นในการค้นหาพิกัด
